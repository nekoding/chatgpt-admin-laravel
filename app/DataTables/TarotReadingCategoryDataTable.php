...
class TarotReadingCategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('action', function (Language $language) {
                return view('pages.reading_category.datatable_action', compact('language'));
            })
            ->addIndexColumn()
            ->setRowId('id')
            ->rawColumns(['action']);
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->addTableClass('w-100')
            ->responsive(true)
            ->setTableId('tarotreadingcategory-table')
    ...
    {
        return 'TarotReadingCategory_' . date('YmdHis');
    }
}
